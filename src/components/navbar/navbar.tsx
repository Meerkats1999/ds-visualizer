...
const navBar = (props: any) => {
    ...
    return (
        <Auxillary>
            <nav className="flex items-center flex-wrap bg-teal-700 shadow-xl p-6">
                ...
                <li className="list-none">
                    <div className="group">
                        <div className="dropdown group-hover:text-white inline-block relative">
                            <button className="bg-gray-300 text-gray-700 shadow-lg font-semibold py-2 px-4 rounded inline-flex items-center">
